...
let deleteTask = async () => {
    ...
    console.log("Task has been deleted from your to-do list.[view to-do list to chek the updated list");
};
...
let updateTask = async () => {
    ...
    console.log("is successfully updated. [view to-do list to check the updated list]");
};
main();
